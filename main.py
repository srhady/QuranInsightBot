...
def generate_and_post():
    ...
    ৩. কোরআন: কোরআনের রেফারেন্স দিলে প্রথমে আরবি আয়াতটি (হরকতসহ) লিখবে। এরপর অবশ্যই একটি ফাঁকা লাইন (Empty line) রাখবে। তারপর আয়াতের বাংলা অর্থটি হুবহু <blockquote><i>অর্থ...</i></blockquote> এই HTML ট্যাগের ভেতরে লিখবে (যাতে টেলিগ্রামে সুন্দর একটি বর্ডার তৈরি হয়)।
    ৪. তাফসির: আয়াতের ব্যাখ্যার জন্য 'তাফসিরে ইবনে কাসীর' বা নির্ভরযোগ্য তাফসিরের রেফারেন্স উল্লেখ করবে।
    ৫. হাদিস: হাদিস ব্যবহার করলে আরবি দেওয়ার দরকার নেই, শুধু বাংলা অর্থটি <blockquote><i>হাদিসের অর্থ...</i></blockquote> এই HTML ট্যাগের ভেতরে লিখবে।
